...
|---|---|
| [Game Settings](/guides/game-settings) | Name pools, action camera pivots, GIF settings |
| [Characters](/guides/characters) | Prisoner character definitions and hair colours |
